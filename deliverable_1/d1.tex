...
This section talks about the Use Case Diagram of the system. It describes all the various possibilities that each actor has available while using MindMerge
...
Every actor is derived form a base user that possesses registration and authentication events.
In our system the manager actor inherits everything from the assignee actor.
...
\subsection*{Description}
Every anonymous user has the possibility to access our services in multiple ways.
If the user hasn't got and account, first thing he can do is a sign-in, that can either be done with Facebook, Google and via email.
After that, its respective login
