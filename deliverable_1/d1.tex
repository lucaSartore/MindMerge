...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Inserire qui sotto swat + intro %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


% Sovrascrivi questa riga!
...
This module is primary used to define the  \texttt{ServicesBaseClass}
The class has 3 attributes (taskManager, userManager, organizationManager) that are used to interact with the database.
The class has 3 methods that are used to verify permissions of users or organizations.

This class is meant to provide a base class for all the services of the system.
